...
STDMETHODIMP_(NTSTATUS) CMiniportWaveRT::SetGfxState(_In_ ULONG _ulNodeId, _In_ BOOL _bEnable)
{
    ...
    DPF_ENTER(("[CMiniportWaveRT::SetGfxState (_bEnable = %d)]",_bEnable));
...
)
{
    ...
    switch (_targetType)
    {
        case eVolumeAttribute:
			 ...
			 DPF_ENTER(("[CMiniportWaveRT::GetChannelCount::GetVolumChannelCount]"));
             break;
        case eMuteAttribute:
             ntStatus = GetMuteChannelCount(_pulChannelCount);
			 DPF_ENTER(("[CMiniportWaveRT::GetChannelCount::GetMuteChannelCount]"));
             break;
        case ePeakMeterAttribute:
			 DPF_ENTER(("[CMiniportWaveRT::GetChannelCount::GetPeakMeterChannelCount]"));
...
NTSTATUS CMiniportWaveRT::GetPeakMeterChannelCount(_Out_  UINT32 *_pulChannelCount)
{
    ...
    DPF_ENTER(("[CMiniportWaveRT::GetPeakMeterChannelCount]"));
    *_pulChannelCount = m_DeviceMaxChannels;
     return ntStatus;
}
#pragma code_seg("PAGE")
